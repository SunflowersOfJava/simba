package com.caozj.framework.chat.handler;
...
import com.caozj.framework.chat.util.ChatCache;
...
public class ChatHandler implements WebSocketHandler {
	...
	public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {
		...
		// 将聊天记录插入到数据库中
		ChatRecordService chatRecordService = (ChatRecordService) ApplicationContextUtil.getBean("chatRecordService");
