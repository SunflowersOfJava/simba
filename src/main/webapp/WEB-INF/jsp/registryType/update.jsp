		...
		<div style="padding:10px 60px 20px 60px">
			<form id="menuForm" method="post">
				...
				<table cellpadding="0" cellspacing="0" style="table-layout:fixed;">
					<tr>
						<td>名称:</td>
						<td><input class="easyui-textbox" type="text" id="text" name="text" data-options="required:true" style="width:200px" value=""></input></td>
					</tr>
					<tr>
						<td>父菜单:</td>
					...
					<tr>
						<td>URL地址:</td>
						<td><input class="easyui-textbox" type="text" id="url" name="url"  style="width:200px" value=""></input></td>
					</tr>
					<tr>
						<td>排序:</td>
		...
		$(document).ready(function() {
			...
			$("#parentID").combotree({
				...
				onLoadSuccess : function(node, data) {
					...
					if (!parentNode) {
						var root = menuTreeSelect.tree("find", );
