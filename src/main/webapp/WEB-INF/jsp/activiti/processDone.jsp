...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/activiti/processDone.js"></script>
...
<body>
	...
	<div id="panel">
		...
		<div id="toolbar">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="ProcessDone.search();" data-options="iconCls:'icon-search'">查询</a>
		</div>
	</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#table").datagrid({
				url : contextPath + "/processDone/listDataOfEasyUI.do",
				method : "post",
				animate : true,
				toolbar : "#toolbar",
				singleSelect : true,
				...
				columns : [ [ {
					...
					width : 250,
					formatter : function(value, row, index) {
						var html = "<a href=\"javascript:void(0)\" onclick=\"ProcessDone.toView('" + row["id"] + "')\">查看</a>";
						html += "&nbsp;&nbsp;";
