...
<body style="padding:0px;margin:0px">
	...
	<div class="easyui-panel" title="修改代办设置" style="width:700px">
		<div style="padding:10px 60px 20px 60px">
			<form id="processAgencySetForm" method="post">
				<input type="hidden" id="id" name="id" value="${processAgencySet.id}" />
				<table cellpadding="0" cellspacing="0" style="table-layout:fixed;">
					...
					<tr>
						<td>代办人:</td>
						<td><input class="easyui-textbox" type="text" id="agencyAccount" name="agencyAccount" data-options="required:true" style="width:200px" value="${processAgencySet.agencyAccount}"></input></td>
					</tr>
				</table>
			</form>
			<div style="text-align:center;padding:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="ProcessAgencySet.update();" data-options="iconCls:'icon-add'">修改</a> <a href="javascript:void(0)" class="easyui-linkbutton"
